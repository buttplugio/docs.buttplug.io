...
Server (like [Intiface Central](/docs/dev-guide/v4/architecture/intiface.md)). For sake of simplicity,
...
covered in the [cookbook](/docs/dev-guide/v4/cookbook/intro.md) section.
...
Engine/Central](/docs/dev-guide/v4/architecture/intiface.md) does not implement SSL websockets (wss).
