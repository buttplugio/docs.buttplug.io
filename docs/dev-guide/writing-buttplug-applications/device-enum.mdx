...
import RustEnumerationExample from '!!raw-loader!/examples/v4/rust/device_enumeration.rs';
...
import CSharpEnumerationExample from '!!raw-loader!/examples/v4/csharp/DeviceEnumerationExample/Program.cs';
...
import jsEnumerationExample from '!!raw-loader!/examples/v4/javascript/device-enumeration-example.js';
...
import tsEnumerationExample from '!!raw-loader!/examples/v4/typescript/device-enumeration-example.ts';

<CodeBlock language="typescript">{tsEnumerationExample}</CodeBlock>

</TabItem>
<TabItem value="python" label="Python">

import PythonEnumerationExample from '!!raw-loader!/examples/v4/python/device_enumeration.py';

<CodeBlock language="python">{PythonEnumerationExample}</CodeBlock>
