...
import tsExternalConnectorExample from '!!raw-loader!/examples/v4/typescript/remote-connector-example.ts';

<CodeBlock language="typescript">{tsExternalConnectorExample}</CodeBlock>
