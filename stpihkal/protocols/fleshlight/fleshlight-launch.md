...
For more information on device information retreival, including getting firmware versions, CRCs, and other firmware/bootloader related information, see the [Kiiroo Bootloader and Firmware Section](../kiiroo/kiiroo-bootloader.md).
