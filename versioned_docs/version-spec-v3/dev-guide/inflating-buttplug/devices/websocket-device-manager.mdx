...
[STPIHKAL](/docs/stpihkal) for info on the initialization phases of certain
protocols.
...
import PythonWSDMExample from '!!raw-loader!/examples/v3/python/websocket-device-manager-example.py';
