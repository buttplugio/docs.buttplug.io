...
import RustExample from '!!raw-loader!/examples/v3/rust/src/bin/async.rs';
...
import CSharpExample from '!!raw-loader!/examples/v3/csharp/AsyncExample/Program.cs';
...
import jsExample from '!!raw-loader!/examples/v3/javascript/async-example.js';
...
import RustErrorExample from '!!raw-loader!/examples/v3/rust/src/bin/errors.rs';
...
import CSharpErrorsExample from '!!raw-loader!/examples/v3/csharp/ExceptionExample/Program.cs';
...
import jsErrorsExample from '!!raw-loader!/examples/v3/javascript/errors-example.js';
