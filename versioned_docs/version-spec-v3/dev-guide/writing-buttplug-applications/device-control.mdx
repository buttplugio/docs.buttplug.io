...
import RustControlExample from '!!raw-loader!/examples/v3/rust/src/bin/device_control.rs';
...
import CSharpControlExample from '!!raw-loader!/examples/v3/csharp/DeviceControlExampleNetCore/Program.cs';
...
import jsControlExample from '!!raw-loader!/examples/v3/javascript/device-control-example.js';
