...
import RustEnumerationExample from '!!raw-loader!/examples/v3/rust/src/bin/device_enumeration.rs';
...
import CSharpEnumerationExample from '!!raw-loader!/examples/v3/csharp/DeviceEnumerationExampleNetCore/Program.cs';
...
import jsEnumerationExample from '!!raw-loader!/examples/v3/javascript/device-enumeration-example.js';
